...
<head>
    ...
    <title>Impulsa Cacecob - Iniciar sesion</title>
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="{{ route('login.post') }}">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="email" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address..." required>
                                        </div>
                                        <div class="form-group">
