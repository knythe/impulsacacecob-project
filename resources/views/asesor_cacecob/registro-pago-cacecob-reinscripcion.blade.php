            ...
            <div id="content">
                ...
                <div class="container-impulsa">
                    ...
                    <div class="form-container-impulsa">
                        <div class="row">
                            <form action="{{ route('cacecobpago.store') }}" id="create_nuevo_pago_reinscripcion" method="post">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group row">
                                        <div class="form-group col-sm-12 mb-3 mb-sm-0">
                                            ...
                                            <input type="text" class="form-control" id="estudiante" name="estudiante" placeholder="Ingrese nombres del apoderado" value="{{ session('clientereinscribir')->nombres ?? '' }} {{ session('clientereinscribir')->apellidos ?? '' }}" readonly>
