                        ...
                        <form action="{{ route('cacecobventas.store') }}" id="create_ventacacecob" method="post">
                            ...
                            <div class="form-group">
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="form-group col-sm-7">
                                            ...
                                            <input type="text" class="form-control" id="" name="" value="{{ session('clientereinscribir')->nombres ?? '' }} {{ session('clientereinscribir')->apellidos ?? '' }}" readonly>
                                            <input type="hidden" id="clientecacecob_id" name="clientecacecob_id" value="{{ session('clientereinscribir')->id}}">
                                        </div>
                                        <div class="form-group col-sm-5">
                                            <label for="">Documento de identidad:</label>
                                            <input type="text" class="form-control" id="" name="" value="{{ session('clientereinscribir')->documento_identidad ?? '' }}" readonly>
                                        </div>
                                        <div class="form-group col-sm-6">
                                            <label for="">Email de contacto:</label>
                                            <input type="text" class="form-control" id="" name="" value="{{ session('clientereinscribir')->email ?? '' }}" readonly>
                                        </div>
                                        <div class="form-group col-sm-6">
                                            <label for="">Telefono de contacto:</label>
                                            <input type="text" class="form-control" id="" name="" value="{{ session('clientereinscribir')->telefono ?? '' }}" readonly>
                                        </div>
                                        <div class="form-group col-sm-6">
                                            <label for="">Codigo de operacion:</label>
                                            <input type="text" class="form-control" id="" name="" value="{{$ultimo_pagocacecob->comprobante->codigo_operacion ?? ''}}" readonly>
                                        </div>
                                        <div class="form-group col-sm-6">
                                            <label for="">Numero de comprobante:</label>
                                            <input type="text" class="form-control" id="" name="" value="{{$ultimo_pagocacecob->comprobante->numero_comprobante ?? ''}}" readonly>
                                        </div>
                                        <div class="form-group col-sm-12">
                                            <label for="pagocacecob_id">Metodo de pago:</label>
                                            <input type="text" class="form-control" id="" name="" placeholder="Ingrese codigo de operacion" value="{{$ultimo_pagocacecob->comprobante->tipo_pago ?? ''}}" readonly>
                                            <input type="hidden" id="pagocacecob_id" name="pagocacecob_id" value="{{$ultimo_pagocacecob->id}}">
                                        </div>
                                        <div class="form-group col-sm-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group col-sm-4">
                                        <button type="submit" class="btn btn-primary-asesor-cacecob btn-ciclos hide-on-pdf" id="save-button" title="Siguiente">Registrar Venta</button>
                                    </div>
                                </div>
