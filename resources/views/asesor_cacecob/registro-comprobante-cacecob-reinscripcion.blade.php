                ...
                <div class="container-impulsa">
                    ...
                    <div class="form-container-impulsa">
                        <div class="row">
                            ...
                            <form action="{{ route('comprobantes.store') }}" id="create_comprobante_cacecob_reinscripcion" method="post">
                                @csrf
                                ...
                                <div class="form-group">
                                    <div class="form-group row">
                                        <div class="form-group col-sm-6">
                                            ...
                                            <label for="email" class="center-text-label text-primary-cacecob">*valido usar numero de comprobante*</label>
                                        </div>
                                        <div class="form-group col-sm-6">
