                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 mx-auto">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form class="edit_ciclo" action="{{ route('ciclos.update', $ciclo->id) }}" method="POST">
                                        <!--ROUTES-->
                                        @csrf
                                        @method('PUT')
                                        <div class="form-group row">
                                            <div class="form-group col-sm-6 mb-3 mb-sm-0">
                                                ...
                                                <input type="text" class="form-control" name="nombre_ciclo" id="nombre_ciclo" title="Ingresa el nombre del ciclo" placeholder="Ingresa el nombre del ciclo" oninput="soloLetras(this)" value="{{($ciclo->nombre_ciclo)}}" required>
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label for="fecha_inicio"> Fecha de inicio del ciclo:</label>
                                                <input type="date" class="form-control" id="fecha_inicio" name="fecha_inicio" title="Ingresa la fecha de inicio del ciclo" placeholder="Ingresar fecha de inicio" value="{{($ciclo->fecha_inicio)}}" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="form-group col-sm-6 mb-3 mb-sm-0">
                                                <label for="fecha_finalizacion"> Fecha de finalizacion del ciclo:</label>
                                                <input type="date" class="form-control" id="fecha_finalizacion" name="fecha_finalizacion" title="Ingrese la fecha de finalizacion del ciclo" placeholder="Ingresar fecha de inicio" value="{{($ciclo->fecha_finalizacion)}}" required>
                                            </div>
                                            <div class="form-group col-sm-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group col-sm-6 mb-3 mb-sm-0">
                                                ...
                                                <select class="form-control" id="empleado_id" name="empleado_id" required>
                                                    ...
                                                    <!-- Esta linea permite obtener los datos del empleado, pero que estan registrados previamente-->
                                                    <option value="{{ $item->id }}" {{ $ciclo->empleado_id == $item->id ? 'selected' : '' }}>{{ $item->nombres ?? '' }} {{$item->apellidos ?? ''}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label for="campus"> Sucursal:</label>
                                                <input type="text" class="form-control" name="campus" id="campus" placeholder="Ingrese la sucursal para el ciclo" oninput="soloLetrasNumeros(this)" value="{{($ciclo->campus)}}" required>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="form-group col-sm-12">
                                                ...
                                                <input type="text" class="form-control" name="direccion_campus" id="direccion_campus" placeholder="Ingrese direccion de la sucursal" oninput="soloLetrasNumeros(this)" value="{{($ciclo->direccion_campus)}}" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="form-group col-sm-12 mb-3 mb-sm-0">
                                                <label for="referencia_campus"> Referencia de la sucursal:</label>
                                                <input type="text" class="form-control" name="referencia_campus" id="referencia_campus" placeholder="Ingrese referencia de la sucursal" oninput="soloLetrasNumeros(this)" value="{{($ciclo->referencia_campus)}}" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="form-group col-sm-12 mb-3 mb-sm-0">
