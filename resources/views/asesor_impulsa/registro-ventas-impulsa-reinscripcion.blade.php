                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="form-group col-sm-3 mb-3 mb-sm-0">
                                                    ...
                                                    <input type="text" class="form-control text-center" style="color:black" id="telefono_secundario_apoderado" name="telefono_secundario_apoderado" placeholder="Ingrese nombres del apoderado" value="{{ $ultimo_pago->estudiante->apoderado->telefono_secundario ?? 'S/N'}} " readonly>
                                            ...
                                            <div class="form-group row" style="margin-bottom: 0px">
                                                ...
                                                <div class="form-group col-sm-2 mb-3 mb-sm-0">
                                                    ...
                                                    <select class="form-control" style="background-color: #0245A0; color:white " id="prenda" name="prenda" required>
