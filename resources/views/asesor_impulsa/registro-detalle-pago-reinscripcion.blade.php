            ...
            <div id="content">
                ...
                <div class="container-impulsa">
                    ...
                    <div class="form-container-impulsa">
                        <div class="row">
                            <form action="{{ route('pago.store') }}" id="create_nuevo_pago_reinscripcion" method="post">
                                @csrf
                                ...
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="form-group col-sm-12 mb-3 mb-sm-0">
                                            ...
                                            <input type="text" class="form-control" id="apoderado" name="apoderado" placeholder="Ingrese nombres del apoderado" value="{{ $ultimo_comprobante->apoderado->nombres ?? '' }} {{ session('estudiantereinscribir')->apoderado->apellidos ?? '' }}" readonly>
                                            <input type="hidden" id="comprobante_id" name="comprobante_id" value="{{ $ultimo_comprobante->id ?? '' }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="form-group col-sm-12 mb-3 mb-sm-0">
                                            <label for="estudiante_id">Datos del estudiante:</label>
                                            <input type="text" class="form-control" id="estudiante" name="estudiante" placeholder="Ingrese nombres del apoderado" value="{{ session('estudiantereinscribir')->nombres ?? '' }} {{ session('estudiantereinscribir')->apellidos ?? '' }}" readonly>
                                            <input type="hidden" id="estudiante_id" name="estudiante_id" value="{{ session('estudiantereinscribir')->id ?? '' }}">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="form-group row">
